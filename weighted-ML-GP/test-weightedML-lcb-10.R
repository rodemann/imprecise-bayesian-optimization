...
save(w_paths_mop, file = "weighted-ML-GP/results/weighted-ML-results-mop-n-100-iters-20-ninit-4-funs1-3-4-6-8-lcb-10")
save(w_paths_mop_sd, file = "weighted-ML-GP/results/weighted-ML-results-mop-sd-n-100-iters-20-ninit-4-funs1-3-4-6-8-lcb-10")
save(uw_paths_mop, file = "weighted-ML-GP/results/unweighted-ML-results-mop-n-100-iters-20-ninit-4-funs1-3-4-6-8-lcb-10")
save(uw_paths_mop_sd, file = "weighted-ML-GP/results/unweighted-ML-results-mop-sd-n-100-iters-20-ninit-4-funs1-3-4-6-8-lcb-10")

# save(global_res_weightedML, file = "weighted-ML-GP/results/weighted-ML-results-global-n-100-iters-20-ninit-4-funs19-1-3-4-6-8")
# save(global_res_unweightedML, file = "weighted-ML-GP/results/weighted-ML-results-global-n-100-iters-20-ninit-4-funs19-1-3-4-6-8")
