...
for (i in 1:length(funs_to_test)) {
  ...
  # lrn <- makeLearner("regr.km", optim.method = "gen", predict.type = "se",
  ...
  # Nuggets = 1e-8*var(y)
  # lrn_classic = setHyperPars(learner = lrn, nugget=Nuggets)
  # 
  ## end BO settings
  ...
  for (test_run in 1:n) {
    ...
    }, error=function(e){cat("ERROR in unweighted bo", test_run, conditionMessage(e), "\n")})
  ...
  # retrieve incumbent best target value
...
save(w_paths_mop, file = "weighted-ML-GP/results/weighted-ML-results-mop-n-100-iters-20-ninit-4-mexican-hat")
save(w_paths_mop_sd, file = "weighted-ML-GP/results/weighted-ML-results-mop-sd-n-100-iters-20-ninit-4-mexican-hat")
save(uw_paths_mop, file = "weighted-ML-GP/results/unweighted-ML-results-mop-n-100-iters-20-ninit-4-mexican-hat")
save(uw_paths_mop_sd, file = "weighted-ML-GP/results/unweighted-ML-results-mop-sd-n-100-iters-20-ninit-4-mexican-hat")

save(global_res_weightedML, file = "weighted-ML-GP/results/weighted-ML-results-global-n-100-iters-20-ninit-4-mexican-hat")
save(global_res_unweightedML, file = "weighted-ML-GP/results/weighted-ML-results-global-n-100-iters-20-ninit-4-mexican-hat")
