...
for (i in 1:length(funs_to_test)) {
  ...
  ctrl <- setMBOControlInfill(ctrl, crit = makeMBOInfillCritCB(cb.lambda = 2), opt = "focussearch",
...
save(w_paths_mop, file = "weighted-ML-GP/results/weighted-ML-results-mop-n-100-iters-20-ninit-4-mexican-hat-rs-lcb-2")
save(w_paths_mop_sd, file = "weighted-ML-GP/results/weighted-ML-results-mop-sd-n-100-iters-20-ninit-4-mexican-hat-rs-lcb-2")
save(uw_paths_mop, file = "weighted-ML-GP/results/unweighted-ML-results-mop-n-100-iters-20-ninit-4-mexican-hat-rs-lcb-2")
save(uw_paths_mop_sd, file = "weighted-ML-GP/results/unweighted-ML-results-mop-sd-n-100-iters-20-ninit-4-mexican-hat-rs-lcb-2")
