...
for (i in 1:length(funs_to_test)) {
  ...
  ctrl <- setMBOControlInfill(ctrl, crit = makeMBOInfillCritCB(cb.lambda = 0.5), opt = "focussearch",
...
save(w_paths_mop, file = "weighted-ML-GP/results/weighted-ML-results-mop-n-5000-iters-20-ninit-4-mexican-hat-rs-lcb-0.5")
save(w_paths_mop_sd, file = "weighted-ML-GP/results/weighted-ML-results-mop-sd-n-5000-iters-20-ninit-4-mexican-hat-rs-lcb-0.5")
save(uw_paths_mop, file = "weighted-ML-GP/results/unweighted-ML-results-mop-n-5000-iters-20-ninit-4-mexican-hat-rs-lcb-0.5")
save(uw_paths_mop_sd, file = "weighted-ML-GP/results/unweighted-ML-results-mop-sd-n-5000-iters-20-ninit-4-mexican-hat-rs-lcb-0.5")
