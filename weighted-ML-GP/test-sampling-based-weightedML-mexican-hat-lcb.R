...
funs_to_test = funs_to_test[[5]] # only mexican hat
...
save(w_paths_mop, file = "weighted-ML-GP/results/weighted-ML-results-mop-n-100-iters-25-ninit-4-mhat-lcb-sampling-based-low-vals")
save(w_paths_mop_sd, file = "weighted-ML-GP/results/weighted-ML-results-mop-sd-n-100-iters-25-ninit-4-funs-mhat-lcb-sampling-based-low-vals")
save(uw_paths_mop, file = "weighted-ML-GP/results/unweighted-ML-results-mop-n-100-iters-25-ninit-4-funs-mhat-lcb-sampling-based-low-vals")
save(uw_paths_mop_sd, file = "weighted-ML-GP/results/unweighted-ML-results-mop-sd-n-100-iters-25-ninit-4-funs-mhat-lcb-sampling-based-low-vals")
